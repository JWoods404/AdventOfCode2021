...
namespace AdventOfCode2021
{
    class Day7
    {
        public long horizonalPosition()
        {
            const string PATH = "C:\\Users\\User\\OneDrive\\Documents\\AdventOfCode2021_Day7.txt";

            string text = System.IO.File.ReadAllText(PATH);

            var arrayText = text.Split(",");
            int[] intArray = new int[arrayText.Length];
            for (int i = 0; i < arrayText.Length; i++)
            {
                intArray[i] = int.Parse(arrayText[i]);
            }

            var max = intArray.Max();

            long[] crabGroup = new long[max + 1];

            foreach (var crab in arrayText)
            {
                crabGroup[int.Parse(crab)]++;
            }
            ...
            for (int i = 0; i < intArray.Length; i++)
            {
                ...
                {
                    fuel += Math.Abs(intArray[i] - intArray[j]);
                }
                fuelCost.Add(fuel);
            }
        ...
        public long horizonalPositionCostlyFuel()
        {
            const string PATH = "C:\\Users\\User\\OneDrive\\Documents\\AdventOfCode2021_Day7.txt";
            ...
            var arrayText = text.Split(",");
            long[] intArray = new long[arrayText.Length];
            for (int i = 0; i < arrayText.Length; i++)
            {
                intArray[i] = long.Parse(arrayText[i]);
            }
            ...
            List<long> fuelCost = new List<long>();
            long fuel;
            int expense;
            ...
            for (int i = 0; i < intArray.Length; i++)
            {
                ...
                for (int j = 0; j < intArray.Length; j++)
                {
                    long fuelCostRound = Math.Abs(intArray[i] - intArray[j]);
                    fuel += fuelCostRound + Increase(fuelCostRound);
                }
                fuelCost.Add(fuel);
            }
        ...
        public long Test(long n, long i =1)
        {
            if (n == 1) return i;
            i += (n);
            n--;
        ...
        public long Increase(long n, long i = 1)
        {
            if (n == 1) return i;
            i += (n);
            n--;
